...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h5b4ce764dd3cbadc: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h891ff0966aef9ea4: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__h7ad4a56dd4eaab16: (a: number, b: number) => void;
