...
- Chain ID: 0x1
- Public RPC URL: [https://api.mainnet-beta.solana.com](https://api.mainnet-beta.solana.com/) (avoid public RPC in production; prefer managed services)
- Display Name: Solana Mainnet
- Block Explorer Link: [https://explorer.solana.com](https://explorer.solana.com/)
- Ticker: SOL
- Ticker Name: Solana
- Logo: [https://images.toruswallet.io/solana.svg](https://images.toruswallet.io/solana.svg)
