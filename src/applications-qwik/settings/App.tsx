...
import IntegrationsPage from './pages/integrations/index.tsx'
import { createLogger } from '../../lib/logger'

const logger = createLogger('QwikSettingsApp');

// Define valid routes for type safety
type ValidRoute = '/' | '/dashboard' | '/counter' | '/integrations'
    ...
    <div class={`min-h-screen flex ${isDark.value ? 'bg-zinc-900 text-gray-100' : 'bg-gray-50'}`}>
      ...
      <div class={`flex-1 transition-all duration-300 ease-in-out ${
        ...
        <main class="p-4 lg:p-8">
          ...
          {currentPath.value === '/integrations' && (
