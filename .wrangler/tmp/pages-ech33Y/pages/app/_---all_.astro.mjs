...
const DashboardPage = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_shGdx1udu0s, "s_shGdx1udu0s"));
...
const s_ljJMXb0lAFY = (props) => {
  const count = useSignal(0);
  const increment = /* @__PURE__ */ inlinedQrl(s_W8AzicVfYPg, "s_W8AzicVfYPg", [
    count
  ]);
  const decrement = /* @__PURE__ */ inlinedQrl(s_yXPKEBiJl1Y, "s_yXPKEBiJl1Y", [
    count
  ]);
  const reset = /* @__PURE__ */ inlinedQrl(s_Eh10N4g07rM, "s_Eh10N4g07rM", [
    count
  ]);
  return /* @__PURE__ */ _jsxQ("div", null, {
    class: "min-h-[calc(100vh-2rem)]"
...
const CounterPage = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_ljJMXb0lAFY, "s_ljJMXb0lAFY"));

const s_d0TM02gMj94 = (path) => {
...
const s_557LukYeHms = () => {
  ...
  if (isMobile.value) {
    if (sidebarOpen.value) document.cookie = `sidebarOpen=true; path=/; max-age=${31536e3}`;
    else
      document.cookie = `sidebarOpen=; path=/; max-age=0`;
  } else
    document.cookie = `sidebarOpen=${sidebarOpen.value}; path=/; max-age=${31536e3}`;
};
const s_n6TQ2VvwPF4 = () => {
  const [isMobile, sidebarOpen] = useLexicalScope();
  if (isMobile.value) sidebarOpen.value = false;
};
const s_CyBaDy0Zodc = (dark) => {
  const [isDark] = useLexicalScope();
  isDark.value = dark;
  localStorage.setItem("darkMode", dark.toString());
  document.cookie = `theme=${dark ? "dark" : "light"}; path=/; max-age=${31536e3}`;
...
const s_rmMkslAO8jk = (props) => {
  _jsxBranch();
  const currentPath = useSignal(props.initialRoute);
  const isDark = useSignal(props.initialTheme === "dark");
  const sidebarOpen = useSignal(props.initialSidebarOpen);
  const isMobile = useSignal(props.initialIsMobile);
  console.log("🚀 [QWIK /app] Component Init:", {
    initialRoute: props.initialRoute,
    initialTheme: props.initialTheme,
    initialSidebarOpen: props.initialSidebarOpen,
    initialIsMobile: props.initialIsMobile,
    windowWidth: typeof window !== "undefined" ? window.innerWidth : "SSR"
  });
  const navigate = /* @__PURE__ */ inlinedQrl(s_d0TM02gMj94, "s_d0TM02gMj94", [
    currentPath,
    isMobile,
    sidebarOpen
  ]);
  const toggleSidebar = /* @__PURE__ */ inlinedQrl(s_557LukYeHms, "s_557LukYeHms", [
    isMobile,
    sidebarOpen
  ]);
  const closeSidebar = /* @__PURE__ */ inlinedQrl(s_n6TQ2VvwPF4, "s_n6TQ2VvwPF4", [
    isMobile,
    sidebarOpen
  ]);
  useVisibleTaskQrl(/* @__PURE__ */ _noopQrl("s_xc30bX4Qimc", [
    isMobile,
    props,
    sidebarOpen
  ]));
  const updateTheme = /* @__PURE__ */ inlinedQrl(s_CyBaDy0Zodc, "s_CyBaDy0Zodc", [
    isDark
  ]);
  const toggleTheme = /* @__PURE__ */ inlinedQrl(s_0HCJ4ElywR8, "s_0HCJ4ElywR8", [
    isDark,
    updateTheme
  ]);
  ...
  return /* @__PURE__ */ _jsxQ("div", null, {
    ...
    /* @__PURE__ */ _jsxQ("div", {
      class: `w-64 min-h-screen fixed left-0 top-0 z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${isMobile.value ? sidebarOpen.value ? "translate-x-0" : "-translate-x-full" : sidebarOpen.value ? "translate-x-0 lg:w-64" : "translate-x-0 lg:w-16"} ${isDark.value ? "bg-zinc-800 border-zinc-700" : "bg-white border-gray-200"} border-r shadow-lg`
    }, null, [
      /* @__PURE__ */ _jsxQ("div", null, {
        ...
        /* @__PURE__ */ _jsxQ("div", null, {
          ...
          }, null, 3, null), 3, "XM_1") : /* @__PURE__ */ _jsxQ("svg", null, {
            class: "w-4 h-4",
            fill: "none",
            stroke: "currentColor",
            viewBox: "0 0 24 24"
      ...
      /* @__PURE__ */ _jsxQ("nav", null, {
        ...
        /* @__PURE__ */ _jsxQ("div", null, {
          ...
          onClick$: /* @__PURE__ */ _noopQrl("s_1qu7zLtAEFw", [
            item,
            navigate
          ])
        }, null, [
        ...
        /* @__PURE__ */ _jsxQ("div", null, {
          class: _fnSignal((p0) => `pt-4 mt-4 border-t ${p0.value ? "border-zinc-700" : "border-gray-200"}`, [
            isDark
          ], '`pt-4 mt-4 border-t ${p0.value?"border-zinc-700":"border-gray-200"}`')
        }, /* @__PURE__ */ _jsxQ("a", {
          class: `w-full flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 text-left ${isDark.value ? "text-gray-300 hover:text-purple-400 hover:bg-zinc-700" : "text-gray-600 hover:text-purple-600 hover:bg-purple-50"} ${!sidebarOpen.value && !isMobile.value ? "lg:justify-center lg:px-2" : ""}`
        }, {
          href: "/settings",
          title: _fnSignal((p0, p1) => !p1.value && !p0.value ? "Settings" : "", [
            isMobile,
            sidebarOpen
          ], '!p1.value&&!p0.value?"Settings":""')
        }, [
          /* @__PURE__ */ _jsxQ("svg", null, {
            class: "w-5 h-5 flex-shrink-0",
            fill: "none",
    ...
    /* @__PURE__ */ _jsxQ("div", null, {
      class: _fnSignal((p0, p1) => `flex-1 transition-all duration-300 ease-in-out ${p0.value ? "" : p1.value ? "lg:ml-64" : "lg:ml-16"}`, [
        isMobile,
        sidebarOpen
      ], '`flex-1 transition-all duration-300 ease-in-out ${p0.value?"":p1.value?"lg:ml-64":"lg:ml-16"}`')
    }, [
      /* @__PURE__ */ _jsxQ("div", {
        ...
        /* @__PURE__ */ _jsxQ("button", null, {
          ...
          "stroke-width": "2",
          d: "M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"
        }, null, 3, null), 3, "XM_2") : /* @__PURE__ */ _jsxQ("svg", null, {
          class: "w-5 h-5",
          fill: "none",
          stroke: "currentColor",
          viewBox: "0 0 24 24"
...
const App = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_rmMkslAO8jk, "s_rmMkslAO8jk"));

const $$Astro = createAstro();
const $$ = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$;
  console.log("🔒 [APP SPA] Processing protected route:", Astro2.url.pathname);
  ...
  return renderTemplate`<html lang="en"${addAttribute(htmlClass, "class")}> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Qwik SPA</title><meta name="theme-color" content="#18181b"><meta name="color-scheme" content="dark light">${renderHead()}</head> <body${addAttribute(bodyClass, "class")}> <div id="qwik-root" class="h-full"> ${renderComponent($$result, "App", App, { "client:load": true, "initialRoute": initialRoute, "initialTheme": initialTheme, "initialSidebarOpen": initialSidebarOpen, "initialIsMobile": !!isMobileDevice, "client:component-hydration": "load", "client:component-path": "src/applications-qwik/app/App.tsx", "client:component-export": "App" })} </div> <!-- No longer need the theme detection script since we pass it as props --> </body></html>`;
}, "/home/ahmed/Projects-Docforge/Astro/cloudflare-frontend/src/pages/app/[...all].astro", void 0);
const $$file = "/home/ahmed/Projects-Docforge/Astro/cloudflare-frontend/src/pages/app/[...all].astro";
const $$url = "/app/[...all]";
