...
const DashboardPage = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_ylQ0teEBKE0, "s_ylQ0teEBKE0"));
...
const s_hjpUV15smjE = (props) => {
  const count = useSignal(0);
  const increment = /* @__PURE__ */ inlinedQrl(s_3BT977kdszI, "s_3BT977kdszI", [
    count
  ]);
  const decrement = /* @__PURE__ */ inlinedQrl(s_enlgGrbnIas, "s_enlgGrbnIas", [
    count
  ]);
  const reset = /* @__PURE__ */ inlinedQrl(s_hOsrBY9wcpc, "s_hOsrBY9wcpc", [
    count
  ]);
  return /* @__PURE__ */ _jsxQ("div", null, {
    class: "min-h-[calc(100vh-2rem)]"
...
const CounterPage = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_hjpUV15smjE, "s_hjpUV15smjE"));

const s_VgCQ4IPi0N4 = (path) => {
...
const s_tmvsf7PHUmk = (props) => {
  ...
  console.log("🚀 [QWIK /settings] Component Init:", {
  ...
  const navigate = /* @__PURE__ */ inlinedQrl(s_VgCQ4IPi0N4, "s_VgCQ4IPi0N4", [
    currentPath,
    isMobile,
    sidebarOpen
  ]);
  const toggleSidebar = /* @__PURE__ */ inlinedQrl(s_0RyQsN7T49A, "s_0RyQsN7T49A", [
    isMobile,
    sidebarOpen
  ]);
  const closeSidebar = /* @__PURE__ */ inlinedQrl(s_NilxpFHgpNE, "s_NilxpFHgpNE", [
    isMobile,
    sidebarOpen
  ]);
  useVisibleTaskQrl(/* @__PURE__ */ _noopQrl("s_MFvmXxui1SE", [
    currentPath,
    isMobile,
    props,
    sidebarOpen
  ]));
  const updateTheme = /* @__PURE__ */ inlinedQrl(s_xJjV0azXFMk, "s_xJjV0azXFMk", [
    isDark
  ]);
  const toggleTheme = /* @__PURE__ */ inlinedQrl(s_YFS4nXRCeZs, "s_YFS4nXRCeZs", [
    isDark,
    updateTheme
  ]);
    ...
    /* @__PURE__ */ _jsxQ("div", {
      ...
      /* @__PURE__ */ _jsxQ("div", null, {
        ...
        /* @__PURE__ */ _jsxQ("div", null, {
          ...
          }, null, 3, null), 3, "Bt_1") : /* @__PURE__ */ _jsxQ("svg", null, {
            class: "w-4 h-4",
            fill: "none",
            stroke: "currentColor",
            viewBox: "0 0 24 24"
      ...
      /* @__PURE__ */ _jsxQ("nav", null, {
        ...
        onClick$: /* @__PURE__ */ _noopQrl("s_qX3bgKLBerA", [
          item,
          navigate
        ])
      }, null, [
    ...
    /* @__PURE__ */ _jsxQ("div", null, {
      ...
      /* @__PURE__ */ _jsxQ("div", {
        ...
        /* @__PURE__ */ _jsxQ("button", null, {
          ...
          "stroke-width": "2",
          d: "M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"
        }, null, 3, null), 3, "Bt_2") : /* @__PURE__ */ _jsxQ("svg", null, {
          class: "w-5 h-5",
          fill: "none",
          stroke: "currentColor",
          viewBox: "0 0 24 24"
...
const App = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_tmvsf7PHUmk, "s_tmvsf7PHUmk"));

const $$Astro = createAstro();
const $$ = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$;
  console.log("🔒 [SETTINGS SPA] Processing protected route:", Astro2.url.pathname);
  const authToken = Astro2.cookies.get("cognito-auth-token");
  console.log("🍪 [SETTINGS SPA] Cookie inspection:", {
  ...
  if (!authToken || !authToken.value) {
    console.log("❌ [SETTINGS SPA] No auth token found for protected route, redirecting to sign-in");
    return Astro2.redirect("/auth/sign-in", 302);
  }
  try {
    console.log("🔍 [SETTINGS SPA] Validating token for protected route access...");
    const validation = jwtValidator.validateTokenBasic(authToken.value);
    console.log("🔍 [SETTINGS SPA] Protected route token validation:", {
    ...
    if (validation.payload) {
      ...
      console.log("👤 [SETTINGS SPA] User info stored in locals:", {
    ...
    console.error("❌ [SETTINGS SPA] Protected route validation failed:", error);
    Astro2.cookies.delete("cognito-auth-token", {
      path: "/"
    });
    console.log("🔄 [SETTINGS SPA] Redirecting to sign-in due to validation failure");
    return Astro2.redirect("/auth/sign-in", 302);
  }
  ...
  console.log("🔍 [ASTRO SSR /settings] Enhanced Mobile Detection:", {
  ...
  console.log("🎛️ [ASTRO SSR /settings] Sidebar State:", {
  ...
  return renderTemplate`<html lang="en"${addAttribute(htmlClass, "class")}> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Settings - Qwik SPA</title><meta name="theme-color" content="#18181b"><meta name="color-scheme" content="dark light">${renderHead()}</head> <body${addAttribute(bodyClass, "class")}> <div id="qwik-root" class="h-full"> ${renderComponent($$result, "App", App, { "client:load": true, "initialRoute": initialRoute, "initialTheme": initialTheme, "initialSidebarOpen": initialSidebarOpen, "initialIsMobile": !!isMobileDevice, "client:component-hydration": "load", "client:component-path": "src/applications-qwik/settings/App.tsx", "client:component-export": "App" })} </div> <!-- No longer need the theme detection script since we pass it as props --> </body></html>`;
}, "/home/ahmed/Projects-Docforge/Astro/cloudflare-frontend/src/pages/settings/[...all].astro", void 0);
const $$file = "/home/ahmed/Projects-Docforge/Astro/cloudflare-frontend/src/pages/settings/[...all].astro";
const $$url = "/settings/[...all]";
